    ...
    <div className="bg-[linear-gradient(to_right,_#111827,_#1f2937_30%,_#1f2937_70%,_#111827)] min-h-screen">
      <div className="relative p-6 max-w-5xl mx-auto text-white">
        ...
        <div className="mt-8 text-center">
          <h2 className="text-3xl font-bold drop-shadow-[0_0_12px_rgba(255,255,255,0.4)]">Library</h2>
          <p className="mt-4 text-indigo-300">This is a placeholder for the Library page. Future development will include search, filtering, and deep dives into every game in the archive.</p>
        </div>
      </div>
    </div>
  );
